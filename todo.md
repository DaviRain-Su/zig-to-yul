...
- implement a zig sdk 
- implement a cli for dev easy developer evm smartcontract with zig sdk
- how to call evm smartcontract on ethereum network and this contract is implemented by solidity?
- deploy supply network not pass network and chainid, this just pass a network name
